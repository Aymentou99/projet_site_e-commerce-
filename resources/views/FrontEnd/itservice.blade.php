...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('itservices/cp_code_v1.3_09-09-2021/img/logo/favicon.ico')}}">
    ...
    <!-- Fontawesome -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css"
        integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous" />
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/bootstrap/bootstrap.min.css')}}">

    <!-- Owl Carousel CSS -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/owl-carousel/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/owl-carousel/owl.theme.default.min.css')}}">

    <!-- Responsive Tabs CSS -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/responsive-tabs/responsive-tabs.min.css')}}">

    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/magnific-popup/magnific-popup.min.css')}}">

    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/animate/animate.min.css')}}">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/style.css')}}">

    <!-- Responsive CSS -->
    <link rel="stylesheet" href="{{asset('itservices/cp_code_v1.3_09-09-2021/css/responsive.css')}}">
...
<body >
                    ...
                    <div  class="contain">
                        <div class="navbar-header" style="flex:5;">
                            ...
                            <a class=" smooth-scroll" href="#home">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/img/logo/theOne.png')}}" style="width:8%;height:8%" alt="logo"  >
                            </a>
                        </div>
                            ...
                            <div class="collapse navbar-collapse">
                                <div class="cc">
                                    <ul class="nav navbar-nav pull-right">
                                        <li><a class="smooth-scroll" href="#h2-g" id="home">Home</a></li>
                                    </ul>

                                    <div class="dropdown">
                                        <a class="en dropbtn"  id="res">EN</a>

                                        <div class="dropdown-content">
                                            <a href="#" id="jp" class="de">JA</a>
                                            <a href="#" class="en" id="eng">EN</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="mobile-nav">
                        ...
                        <div id="mobile-nav-content">
                            <ul class="nav">
                                ...
                                <li><a class="smooth-scroll" href="#" id="jpp">JA</a></li>
        ...
        <div id="home-content">
            <div id="home-content-inner" class="text-center">
                ...
                <div id="home-heading">
                    ...
                    <h1 id="home-heading-2">Creative <span style="color: #3742da;">Agency</span></h1>
                </div>

                <div id="home-text">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam in nihil minima unde qui nihil
                        minima.</p>
                </div>
            </div>
        </div>
    ...
    <section class="cards-section " id="group-sec"  data="group-sec"       style="background-image: url(./image-background.jpg);

    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;">
        <header class="cards-header">
            <img id="gr-image" src="{{asset('itservices/cp_code_v1.3_09-09-2021/group-section2.png')}}" alt="Group Section" class="gr-image-group">
        ...
        <div class="cards">
            ...
            <div class="card iot-bg-card wow fadeInLeft ">
                <div class="black">
                    ...
                    <p class="button-explore position2 has-outline pos ">
                        <a href="#webc">
                            <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/group_section/icons/iot-icon-white.png')}}">
                            <span id="explore1">
                                Explore
                            </span>
                        </a>
            ...
            <div class="card dev-bg-card wow fadeInUp" data-wow-duration="2s">
                <div class="black">
                    ...
                    <p class="button-explore position2 has-outline pos ">
                        <a href="#DEV">
                            <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/group_section/icons/dev-icon-white.png')}}">
                            <span id="explore2">
                                Explore
                            </span>
                        </a>
            ...
            <div class="card ai-bg-card wow fadeInRight">
                <div class="black">
                    ...
                    <p class="button-explore position2 has-outline pos ">
                        <a href="#AIS">
                            <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/group_section/icons/ai-icon-white.png')}}">
                            <span id="explore3">
                                Explore
                            </span>
                        </a>
    ...
    <section class="app iot-back" data="webc" id="webc" >
        ...
        <div class="cards-im">
            <div class="card-im1 iot-card wow fadeInLeft">
                <div class="overlay1">
                    <div class="ggg ">
                        <h2 id="head1">
                        ...
                        <p id="par1-head1">
                            ...
                            <a href="#home-start" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div class="card-im1 iot-card  active  wow fadeInUp" data-wow-duration="2s">
                ...
                <div class="overlay1">
                    ...
                    <div class="ggg ">
                        ...
                        <p id="par2-head2">
                            ...
                            <a href="#home2g" class="smooth-scroll" style="text-transform: capitalize;text-align: center;color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div class="card-im1 iot-card wow  fadeInRight ">
                <div class="overlay1">
                    ...
                    <div class="ggg">
                        ...
                        <p id="par3-head3">
                            ...
                            <a href="#home3g" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div id="services-01">
                <div class="content-box-lg   ">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInLeft "style="    margin-top:-36px;">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/embedded systems development/embedded-system-image.jpg')}}" alt="laptop"
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/embedded systems development/embedded-system-icon-2.png')}}"
                                ...
                                <div class="service" style="margin-top: 0px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/embedded systems development/our-services-icon.png')}}"
                                                    alt="laptop" class="resp-image">
                                            </div>
                                        </div>
    ...
    <section id="services " data="webc" class="secs"  >
        <div id="home-start2">
            <!-- Services 01 -->
            <div id="services-01">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                ...
                                <div class="service" style="margin-top: -7px;">
                                    <!-- <header class="text-left  head-services" id="big-em2">
                                        <h2>Wireless Technologies</h2>
                                    </header> -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/wireless technologies/wireless-technologies-icon.png')}}"
                                                    alt="laptop" class="resp-image">
                                            </div>
                                        </div>
                                ...
                                <div class="service" style="margin-top: 0px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/wireless technologies/our-services-icon.png')}}"
                                                    alt="laptop" class="resp-image">
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInLeft "     style="margin-top: -10px;">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/wireless technologies/wireless-technologies-image.jpg')}}" alt="laptop"
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInLeft ">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/pcb design/pcb-design-image.jpg')}}" alt="laptop"
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                ...
                                <div class="service" style="margin-top: -7px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/pcb design/pcb-design-icon.png')}}" alt="laptop"
                                               class="resp-image">
                                            </div>
                                        </div>
                                ...
                                <div class="service" style="margin-top:-7px">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/iot/pcb design/our-services-icon.png')}}" alt="laptop"
                                             class="resp-image">
                                            </div>
                                        </div>
                                        <div class="col-md-10 col-sm-10">
    ...
    <section class="app imagedv" data="DEV" id="DEV">
        <div class="cards-im">
            <div class="card-im1 card-imgdev   wow fadeInLeft">
                <div class="overlay1">
                    <div class="ggg ">
                        <h2 id="par-dev-h1">
                            Websites
                        ...
                        <p id="par-dev-1">
                            ...
                            <a href="#dd" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div class="card-im1 card-imgdev  active  wow fadeInUp" data-wow-duration="2s">
                <div class="overlay1">
                    <div class="ggg ">
                        <h2 id="par-dev-h2">
                        ...
                        <p id="par-dev-2">We develop software that helps you scale your business
                            <a href="#desk" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div class="card-im1 card-imgdev  wow  fadeInRight ">
                <div class="overlay1">
                    <div class="ggg ">
                        <h2 id="par-dev-h3">
                        ...
                        <p id="par-dev-3">
                            ...
                            <a href="#Android" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
        ...
        <div id="services-01">
            <div class="content-box-lg " id="dd">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 wow slideInLeft " >
                            <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/websites/websites-image.jpg')}}" alt="laptop"
                            class="img-responsive" style="width: 90%;height: 90%;margin-left: 30px;border-radius: 0.6rem;
                                box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.1), 0px 20px 20px rgba(0, 0, 0, 0.1);
                             margin-top: -10px;
                                ">
                        ...
                        <div class="col-md-6 col-sm-6 wow slideInRight ">
                            ...
                            <div class="service" style="margin-top: -7px;">
                                <div class="row">
                                    <div class="col-md-2 col-sm-2">
                                        <div class="icon text-right">
                                            <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/websites/websites-icon.png')}}" alt="laptop"
                                          class="resp-image">
                                        </div>
                                    </div>
                            ...
                            <div class="service" style="margin-top: 0px;">
                                <div class="row">
                                    <div class="col-md-2 col-sm-2">
                                        <div class="icon text-right">
                                            <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/websites/our-services-icon.png')}}" alt="laptop"
                                         class="resp-image">
                                        </div>
                                    </div>
                ...
                <div class="content-box-lg" >
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                ...
                                <div class="service"          style="margin-top: -7px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/desktop/desktop-applications-icon.png')}}"
                                             class="resp-image">
                                            </div>
                                        </div>
                                ...
                                <div class="service"    style="margin-top: 0px;">
                                    <div id="desk">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-2">
                                                <div class="icon text-right">
                                                    <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/desktop/example-icon.png')}}" class="resp-image">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInLeft ">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/desktop/desktop-applications-image.jpg')}}" alt="laptop"
                                    class="img-responsive" style="width: 90%;height: 90%;  border-radius: 0.6rem;
                                        box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.1), 0px 20px 20px rgba(0, 0, 0, 0.1);
                                        margin-top: -10px;">
                            </div>
            ...
            <div id="services-01">
                <div class="content-box-lg   ">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInLeft ">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/mobile/android-ios-applications-image.jpeg')}}" alt="laptop"
                                    class="img-responsive" style="width: 90%;height: 90%;margin-left: 30px;border-radius: 0.6rem;
                                        box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.1), 0px 20px 20px rgba(0, 0, 0, 0.1);
                                        margin-top: -10px;
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                ...
                                <div class="service" style="margin-top: -7px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/mobile/mobile-icon.png')}}" alt="laptop"
                                             class="resp-image">
                                            </div>
                                        </div>
                                ...
                                <div class="service" style="margin-top: 0px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/dev/mobile/our-services-icon.png')}}" class="resp-image">
                                            </div>
                                        </div>
    ...
    <section class="app ai-back" data="AIS" id="AIS">
        <div class="cards-im">
            <div class="card-im1 ai-card  wow fadeInLeft">
                <div class="overlay1">
                    <div class="ggg ">
                        <h2 id="par-ai-h1">
                            AI Consulting
                        ...
                        <p id="par-ai-1">
                            ...
                            gathered data
                            <a href="#AI" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div class="card-im1 ai-card active  wow fadeInUp" data-wow-duration="2s">
                <div class="overlay1">
                    <div class="ggg ">
                        <h2 id="par-ai-h2">
                            Data Analytics
                        ...
                        <p id="par-ai-2">
                            ...
                            <a href="#Data" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div class="card-im1 ai-card wow  fadeInRight ">
                <div class="overlay1">
                    <div class="ggg ">
                        <h2 id="par-ai-h3">
                            Automation
                        ...
                        <p id="par-ai-3">
                            ...
                            <a href="#Auto" class="smooth-scroll" style="text-transform: capitalize;text-align: center; color: #BB0000;">
                                More >>
                            </a>
                        </p>
                    </div>
            ...
            <div id="services-01">
                <div class="content-box-lg   ">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInLeft ">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/ai consulting/ai-consulting-image.jpeg')}}" alt="laptop"
                                    class="img-responsive" style="width: 90%;height: 90%;margin-left: 30px;border-radius: 0.6rem;
                                        box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.1), 0px 20px 20px rgba(0, 0, 0, 0.1);
                            margin-top: -10px;
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                ...
                                <div class="service" style="margin-top: -7px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/ai consulting/ai-consulting-icon.png')}}" class="resp-image">
                                            </div>
                                        </div>
                                ...
                                <div class="service" style="margin-top: 0px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/ai consulting/our-services-icon.png')}}" style="width: 80%;height: 80%">
                                            </div>
                                        </div>
                ...
                <div class="content-box-lg   ">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                ...
                                <div class="service" style="margin-top: -7px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/data analytics/ai-data-analytics-icon.png')}}" class="resp-image">
                                            </div>
                                        </div>
                                ...
                                <div class="service"style="margin-top: -0px;" >
                                    <div id="desk">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-2">
                                                <div class="icon text-right">
                                                    <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/data analytics/our-services-icon.png')}}" class="resp-image">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInLeft ">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/data analytics/data-analytics-image.jpg')}}" alt="laptop"
                                    class="img-responsive" style="width: 90%;height: 90%;border-radius: 0.6rem;
                                        box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.1), 0px 20px 20px rgba(0, 0, 0, 0.1);
            ...
            <div id="services-01">
                <div class="content-box-lg   ">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow slideInLeft ">
                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/automation/ai-automation-image.jpg')}}" alt="laptop"
                                class="img-responsive" style="width: 90%;height: 90%;margin-left: 30px;border-radius: 0.6rem;
                                    box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.1), 0px 20px 20px rgba(0, 0, 0, 0.1);
                          margin-top: -10px;"
                            ...
                            <div class="col-md-6 col-sm-6 wow slideInRight ">
                                ...
                                <div class="service" style="margin-top: -7px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021/ai/automation/ai-automation-icon.png')}}" class="resp-image">
                                            </div>
                                        </div>
                                ...
                                <div class="service" style="margin-top: 0px;">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2">
                                            <div class="icon text-right">
                                                <img src="{{asset('itservices/cp_code_v1.3_09-09-2021ai/automation/our-services-icon.png')}}" class="resp-image">
                                            </div>
                                        </div>
    ...
    <footer class="text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>
                        Copyrights &copy; 2021 All Rights Reserved By <span style="color: #3742da;">CP Inc.</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Back To Top -->
        <!-- Changed: delete btn-yellow, and modify btn-back-to-top style-->
        <a href="#group-sec" id="back-to-top" class="btn btn-sm btn-back-to-top smooth-scroll hidden-sm hidden-xs"
    ...
    <!-- JQuery -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/jquery.min.js')}}"></script>

    <!-- Bootstrap JS -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/bootstrap/bootstrap.min.js')}}"></script>

    <!-- Owl Carousel JS -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/owl-carousel/owl.carousel.min.js')}}"></script>

    <!-- Waypoints -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/waypoints/jquery.waypoints.min.js')}}"></script>

    <!-- Responsive Tabs JS -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/responsive-tabs/jquery.responsiveTabs.min.js')}}"></script>
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/tt.js')}}"></script>
    <!-- Isotope -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/isotope/isotope.pkgd.min.js')}}"></script>

    <!-- Magnific Popup -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/magnific-popup/jquery.magnific-popup.min.js')}}"></script>

    <!-- Counter -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/counter/jquery.counterup.min.js')}}"></script>

    <!-- Google Map JS -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD9EdV2JfPG1Vfviw9gf_HlblIUfs7Ie2E"></script>

    <!-- Easing -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/easing/jquery.easing.1.3.min.js')}}"></script>

    <!-- WOW JS -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/wow/wow.min.js')}}"></script>

    <!-- Custom JS -->
    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/script.js')}}"></script>

    <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/buttonevent.js')}}"></script>
        <script src="{{asset('itservices/cp_code_v1.3_09-09-2021/js/scroll.js')}}"></script>
</body>
