...
<a href="{{url('category/'.$products->category->slug_en)}}">{{$products->category->name_en}}</a>/
<a href="{{url('category/'.$products->category->slug_en.'/'.$products->slug_en)}}">{{$products->name_en}}</a>
...
<p class="mt-3">{{$products->small_description_en}}</p>
<hr>
@if($products->qty > 0)
...
<h3>Description</h3>
<p class="mt-3">{{$products->description_en}}</p>
