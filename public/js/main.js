...
/* No need  */
    ...
    * ---------------------------*/ 
    ...
    /*--------------------------
     contact form - enable send btn when checkbox checked
    ---------------------------- */
    $('#check').change(function () {
        $('#btncheck').prop("disabled", !this.checked);
    }).change()

    $('#jp-check').change(function () {
        $('#jp-btncheck').prop("disabled", !this.checked);
    }).change()

    /*--------------------------
     register form - enable send btn when checkbox checked
    ---------------------------- */
    $('#check-register').change(function () {
        $('#register-button').prop("disabled", !this.checked);
    }).change()
